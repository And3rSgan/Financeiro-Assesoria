...
const Dashboard = () => {
  ...
  const [processos, setProcessos] = useState<Array<{ id: string; numero: string; cliente: string; status: string; prazo: string | null; assunto: string | null }>>([]);
    ...
    const load = async () => {
      try {
        ...
        const { data: procs } = await supabase
          .from('processos')
          .select('id, numero, cliente_id, status, data_limite, created_at, assunto')
  ...
  const metrics = useMemo(() => [
    ...
    { title: 'Agendamentos de Hoje', value: String(audienciasHoje), change: '—', icon: Calendar, color: 'text-orange-500', bgColor: 'bg-orange-500/10' },
    ...
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Visão geral Assessoria</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Processos Concluidos</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Novos Processos</span>
                </div>
