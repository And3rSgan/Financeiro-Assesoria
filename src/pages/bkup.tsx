            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="mx-4 max-w-md sm:max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-sm">
                    Use variáveis com colchetes, como [nome_cliente], [id_processo], [status_processo], [valor_honorarios], [data_vencimento], [data_audiencia] e [hora_audiencia].
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 items-start sm:items-center gap-2 sm:gap-4">
                    ...
                    <Textarea
                      ...
                      className="sm:col-span-3 text-sm"
                      placeholder="Ex: Olá [nome_cliente], o status do seu processo [id_processo] foi atualizado."
                    />
                  </div>
                </div>
                <DialogFooter className="flex flex-col-reverse sm:flex-row gap-2">
