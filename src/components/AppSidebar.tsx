    ...
    <Sidebar className="border-r border-border/50">
      <SidebarHeader className="p-6">
        <div className="flex items-center gap-3">
          <div>
            <img src="https://cdn-icons-png.freepik.com/256/8916/8916465.png" alt="Logo" className="w-12 h-12 object-contain" />
          </div>
          <div>
            <h2 className="text-lg font-bold">Painel de Gestão</h2>
            <p className="text-xs text-muted-foreground">Processos Migratorios</p>
          </div>
        </div>
      </SidebarHeader>
