...
select * from (
  values
    (null::uuid, 'Atualização de Processo', 'Olá [nome_cliente], o status do seu processo nº [id_processo] foi atualizado para: [status_processo].', true),
    (null::uuid, 'Lembrete de Agendamento', 'Prezado(a) [nome_cliente], lembramos da sua audiência agendada para o dia [data_audiencia] às [hora_audiencia] referente ao processo nº [id_processo].', true),
