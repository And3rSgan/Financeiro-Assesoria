...
COMMENT ON TABLE equipe IS 'Tabela para gerenciamento de membros da equipe do escritório de assessoria';
COMMENT ON COLUMN equipe.id IS 'Identificador único do membro da equipe';
COMMENT ON COLUMN equipe.user_id IS 'ID do usuário proprietário (Gestor responsável pelo escritório)';
